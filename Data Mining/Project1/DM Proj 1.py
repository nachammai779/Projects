...
def train_and_test_model(path):
    ...
    notcs_cs = list(filter(lambda row: not row[1], classified))[-5:]
    cs_notcs = list(filter(lambda row: row[1], classified))[:5]

    print("notcs_cs", notcs_cs)
    print("cs_notcs", cs_notcs)
    print (' ')
