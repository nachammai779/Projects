...
for z in range (0,20):
    ...
    valuesum = valuesum + ITEMS[z].value
...
def fitness(target):
    ...
    if total_weight > CAPACITY:
        ...
        if total_value > valuesum/2:
            vp = 1.0
        elif total_value > valuesum/3:
            vp = 2.0
        elif total_value > valuesum/4:
            vp = 3.0
        elif total_value > valuesum/5:
            vp = 4.0
        else:
            vp = 5.0

        rv = total_value - (vp*(total_weight - CAPACITY)) - gp
        return rv
    else:
