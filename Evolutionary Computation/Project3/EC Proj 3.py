...
global ap1
global ap2
global constr_viol_count
global constr_viol_value
...
def fitness(target):
    ...
    #print('constr_viol_count: ',constr_viol_count)
    #print('constr_viol_value: ',constr_viol_value)
    ...
    if total_weight > CAPACITY:
        ...
        # Need to be adaptive penalized
        constr_viol_count = constr_viol_count + 1
        constr_viol_value = constr_viol_value + (total_weight - CAPACITY)
        rv = total_value - (coef*ap1+viol*ap2)
...
def main():
    ...
    for g in range(0,GEN_MAX):
        ...
        # Below is caculated for applying adaptive penalty
        if constr_viol_count > 10:
            ap1 = 4
            ap2 = 2
            viol = constr_viol_value*2/100
            coef = coef + 1
        elif constr_viol_count > 1:
            ap1 = 2
            ap2 = 1
            viol = constr_viol_value/100
            coef = coef + 1
        else:
            ap1 = 0
            ap2 = 0
